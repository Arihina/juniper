...
| Структура | Время | Throughput | мкс/op |
| --- | --- | --- | --- |
| dict | 93.0 мс | 5.38M ops/s | 0.19 мкс |
| RHMap | 118.5 мс | 4.22M ops/s | 0.24 мкс |
| SwissTable | 82.0 мс | 6.10M ops/s | 0.16 мкс |

# Lookup hit (str, N=500,000)

| Структура | Время | Throughput | мкс/op |
| --- | --- | --- | --- |
| dict | 158.8 мс | 3.15M ops/s | 0.32 мкс |
| RHMap | 112.3 мс | 4.45M ops/s | 0.22 мкс |
| SwissTable | 146.6 мс | 3.41M ops/s | 0.29 мкс |

# Lookup miss (str, N=500,000)

| Структура | Время | Throughput | мкс/op |
| --- | --- | --- | --- |
| dict | 75.3 мс | 6.64M ops/s | 0.15 мкс |
| RHMap | 69.3 мс | 7.22M ops/s | 0.14 мкс |
| SwissTable | 20.1 мс | 24.93M ops/s | 0.04 мкс |

# Lookup Zipf (str, N=500,000)

| Структура | Время | Throughput | мкс/op |
| --- | --- | --- | --- |
| dict | 8.9 мс | 56.23M ops/s | 0.02 мкс |
| RHMap | 11.8 мс | 42.24M ops/s | 0.02 мкс |
| SwissTable | 13.8 мс | 36.34M ops/s | 0.03 мкс |

# Update all (str, N=500,000)

| Структура | Время | Throughput | мкс/op |
| --- | --- | --- | --- |
| dict | 46.1 мс | 10.83M ops/s | 0.09 мкс |
| RHMap | 66.4 мс | 7.52M ops/s | 0.13 мкс |
| SwissTable | 56.3 мс | 8.88M ops/s | 0.11 мкс |

# Insert+Delete (str, N=500,000)

| Структура | Время | Throughput | мкс/op |
| --- | --- | --- | --- |
| dict | 109.0 мс | 9.18M ops/s | 0.11 мкс |
| RHMap | 161.5 мс | 6.19M ops/s | 0.16 мкс |
| SwissTable | 118.9 мс | 8.41M ops/s | 0.12 мкс |

# Mixed 80R/20W (str, N=500,000)

| Структура | Время | Throughput | мкс/op |
| --- | --- | --- | --- |
| dict | 118.0 мс | 4.24M ops/s | 0.24 мкс |
| RHMap | 123.2 мс | 4.06M ops/s | 0.25 мкс |
| SwissTable | 85.2 мс | 5.87M ops/s | 0.17 мкс |

# Latency percentiles (str, N=500,000)

| Структура | avg | p50 | p90 | p99 | p99.9 |
| --- | --- | --- | --- | --- | --- |
| dict | 0.41μs | 0.36μs | 0.56μs | 1.07μs | 8.24μs |
| RHMap | 0.30μs | 0.27μs | 0.36μs | 0.85μs | 0.98μs |
| SwissTable | 0.36μs | 0.33μs | 0.43μs | 0.95μs | 1.51μs |
